...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { ground: @planet.ground, name: @planet.name, weather: @planet.weather } }, as: :json
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { ground: @planet.ground, name: @planet.name, weather: @planet.weather } }, as: :json
    assert_response 200
  end
